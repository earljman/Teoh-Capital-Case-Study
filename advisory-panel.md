...
3. **Planning** — advisory panel routing, decisions locked (bet, ICP, top 3), skills used (`foundation-prioritized-action-plan`, `define-problem-statement`, `develop-solution-brief`, `deliver-prd`), artifacts in `1-planning/`.
